...
• /blocked_list — список заблокированных пользователей
...
🕐 Дата: {unblocked_at}"""
    ...
    BLOCKED_LIST_HEADER = """🚫 <b>Список заблокированных пользователей</b>

Всего заблокировано: {count}
...
"""
    ...
    LOGS_CLEARED = "✅ <b>Логи успешно очищены</b>\n\nФайл логов был очищен."

    # Уведомления для пользователя
    USER_IS_BLOCKED = """🚫 <b>Доступ к боту ограничен</b>
...
Для получения дополнительной информации обратитесь к администратору Совета."""
    ...
    USER_WAS_UNBLOCKED = """✅ <b>Доступ восстановлен</b>

Ваш аккаунт был разблокирован. Теперь вы снова можете пользоваться ботом."""
